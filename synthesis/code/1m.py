...
X_train=scio.loadmat('40_train_1m.mat')
y_train=scio.loadmat('40_test_1m.mat')
X_test=scio.loadmat('65_train_1m.mat');
y_test=scio.loadmat('65_test_1m.mat');
...
print('1.check :X[4][29] ',X_train[3][28])
...
print('2.check :X[4][29] ',X_train[3][28])
...
##changes made
scio.savemat('Result/1m.mat', dict(pos=y_pred,loss=score,Accuracy=acc))
temp='/home/sgeadmin/Valli/mats_final/synthesis/code/Result/'
#     enc= rbm_ptr.GetWeights()
os.chdir(temp)
model.save_weights('weight_1m',overwrite=True)

...
X_train=scio.loadmat('40_train_3p1m.mat')
y_train=scio.loadmat('40_test_3p1m.mat')
X_test=scio.loadmat('65_train_3p1m.mat');
y_test=scio.loadmat('65_test_3p1m.mat');
...
os.chdir(temp)
model.save_weights('weight_3p1m',overwrite=True)

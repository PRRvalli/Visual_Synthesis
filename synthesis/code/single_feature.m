...
A=load(['/home/prr/intern/Valli/mats_final/Abhishek/65.mat']);
...
Output_feature=Output_feature/125.42;
save('65_train_3m.mat','Input_feature');
save('65_test_3m.mat','Output_feature');

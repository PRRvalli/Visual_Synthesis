...
X_train=scio.loadmat('40_train_3p.mat')
y_train=scio.loadmat('40_test_3p.mat')
X_test=scio.loadmat('65_train_3p.mat');
y_test=scio.loadmat('65_test_3p.mat');
...
##changes made
scio.savemat('Result/3p.mat', dict(pos=y_pred,loss=score,Accuracy=acc))
temp='/home/sgeadmin/Valli/mats_final/synthesis/code/Result/'
#     enc= rbm_ptr.GetWeights()
os.chdir(temp)
model.save_weights('weight_3p',overwrite=True)
